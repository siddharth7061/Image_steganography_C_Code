...
Status encode_secret_file_extn_size(int size, FILE *fptr_src_img, FILE *stego_img);

/* Encode the secret file extension size into lsb of data acquired from the source image */
